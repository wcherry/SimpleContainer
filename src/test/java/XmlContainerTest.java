...
import org.sss.simple.container.XmlContainer;
...
public class XmlContainerTest {
    ...
    static final String BASE_DIRECTORY="./build/resources/test";

    @Test public void testSingleConfigFile() throws Exception {
        XmlContainer c = new XmlContainer();
        c.addXmlConfigFile(BASE_DIRECTORY+"/simple.xml");
        c.init();
        Object o = c.getBean("butter");
        assertNotNull("The container should have a bean named butter", o);
    }

    @Test public void testAnnotatedBeansDoesNotOverrideXml() throws Exception {
        XmlContainer c = new XmlContainer();
        c.addXmlConfigFile(BASE_DIRECTORY+"/simple.xml");
        c.init();
        Object o = c.getBean("boo");
        assertNull("The container should not have a bean named boo", o);
    }
/*

    public static class XmlContainerTest {

        static final String BASE_DIRECTORY="out/test/SimpleContainer";
        ...
        @Test public void testAnnotatedBeansInDirectory() throws Exception {
            SimpleContainer c = new SimpleContainer();
            c.setBeansDirectory(new File(BASE_DIRECTORY+"/test_artifacts/beans"));
            c.init();
